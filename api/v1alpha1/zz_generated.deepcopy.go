...
func (in *APIAPIServer) DeepCopy() *APIAPIServer {
	...
	out := new(APIAPIServer)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *APICerts) DeepCopyInto(out *APICerts) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APICerts.
func (in *APICerts) DeepCopy() *APICerts {
	if in == nil {
		return nil
	}
	out := new(APICerts)
